...
$x = 5;
$y = 2;
echo $x + $y . "<br>";  //7 сложение
echo $x - $y . "<br>";  //3 вычитание
echo $x * $y . "<br>";  // 10умножение
echo $x / $y . "<br>";  // 2.5 деление
echo 10 % 4 .  "<br>";  //2 остаток от деления
echo -(3-4) . "<br>";  // 1 унарное отрицание
echo $x ** 3 .  "<br>"; //125 x в 3ей степени
echo $x ** (1/2) ."<br>"; // 2.2360679774998 Квадратные корень из x

// Приоритеты
echo 3 + 3 * 2 . "<br>"; // Выведет 9
echo (3 + 3) * 2 . "<br>"; // Выведет 12
echo 2/2*2 . "<br>"; // 2 деление и умножение одинаковый приоритет выполниться слева направо
echo 10>3+8 . "<br>"; // +- больший приоритет чем < >ВЫВЕДЕТ ПУСТО 
